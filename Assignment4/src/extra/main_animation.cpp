...
int main() 
{
	...
	// Animation loop 
	// Here we insert some instruction to modify our scene, we shrink our triangle by 0.05 by frame to frame 
	for (float i=0;i<1;i+=0.05)
	{
		frameBuffer.setConstant(FrameBufferAttributes()); // Reset the frame buffe each time 
